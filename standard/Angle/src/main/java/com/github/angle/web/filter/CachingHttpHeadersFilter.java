package com.github.angle.web.filter;

import com.github.angle.config.AngleProperties;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(AngleProperties angleProperties) {
        this.angleProperties = angleProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(angleProperties.getHttp().getCache().getTimeToLiveInDays());
    }
